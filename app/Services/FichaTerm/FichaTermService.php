...
class FichaTermService
{
    ...
    public function getAll()
    {
        ...
        $fichaTerms = FichaTerm::with('ficha', 'term', 'phase')->all();
    ...
    public function getByFichaId($fichaId)
    {
        ...
        $fichaTerms = FichaTerm::with('ficha', 'term', 'phase')->where('ficha_id', $fichaId)->orderBy('start_date')->get();
    ...
    public function update($data, $id)
    {
        ...
        if (array_key_exists('term_id', $data)) {
            ...
            $fichaTermData['term_id'] = $data['term_id'];
        }

        if (array_key_exists('ficha_id', $data)) {

            $fichaTermData['ficha_id'] = $data['ficha_id'];
        }

        if (array_key_exists('phase_id', $data)) {

            $fichaTermData['phase_id'] = $data['phase_id'];
        }

        if (array_key_exists('start_date', $data)) {

            $fichaTermData['start_date'] = $data['start_date'];
        }

        if (array_key_exists('end_date', $data)) {

            $fichaTermData['end_date'] = $data['end_date'];
        }
