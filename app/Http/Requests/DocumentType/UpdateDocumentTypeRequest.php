...
/**
 * Validación **ACTUALIZACIÓN COMPLETA** tipo documento.
 *
 * Reglas: required + unique ignore ID.
 */
class UpdateDocumentTypeRequest extends FormRequest
{
    ...
    /**
     * Reglas validación completa + ignore ID (UPDATE).
     */
    public function rules(): array
    {
        ...
        return [
            'name' => ['required', new AlphaSpaces(), 'string', 'min:10', 'max:50', "unique:document_types,name,{$documentType},id"],
