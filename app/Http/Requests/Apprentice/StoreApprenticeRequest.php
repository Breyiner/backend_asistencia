...
/**
 * Validación **CREACIÓN** aprendiz → crea User + Apprentice.
 *
 * Reglas: document_number/email únicos (users), ficha existe.
 * Custom: AlphaSpaces (solo letras/espacios nombres).
 */
